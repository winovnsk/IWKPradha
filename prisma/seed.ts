...
async function main() {
  ...
  const defaultSettings = [
    ...
    { key: 'sekretaris_rt', value: 'Sekretaris RT 11', description: 'Nama Sekretaris' },
    { key: 'bendahara_rt', value: 'Bendahara RT 11', description: 'Nama Bendahara' },
    { key: 'whatsapp_admin', value: '6281234567890', description: 'Nomor WhatsApp Admin' },
    { key: 'default_iwk_nominal', value: '100000', description: 'Nominal Iuran Bulanan' },
